...
if __name__ == '__main__':
    ...
    action = action_log.join(numViewsFilterGaid, on='gaid', how='inner')\
        .select('gaid', 'video_id', 'tag')\
        .join(numViewsFilterVideo, on='video_id', how='inner')\
        .drop('numViewsVideo')

    action.show()

    res_path = "/home/yujun/Downloads/tag_cluster/action_res_zan/"
    ...
    reshaped1.repartition(1).write\
        ...
        .save("/home/yujun/Downloads/tag_cluster/action_ration_zan/", header='true')

    print("++++++++csv file output done++++++++++++")
    """

    interest_file = "/home/yujun/Downloads/tag_cluster/action_ration_zan/part-00000-3af40404-f9cc-4610-ba8e-a6e2ce9bc5a2-c000.csv"
