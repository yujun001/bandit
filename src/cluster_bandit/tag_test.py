...
def get_user_actoin(ss: SparkSession, tm_now, last_days, action_log_path) -> DataFrame:
    ...
    res = df.filter((col('gaid').isNotNull())
        ...
        .withColumn("pg", F.when((col('counter')>100), 100).otherwise(col('counter')))\
        .drop_duplicates()\
...
if __name__ == '__main__':
    ...
    # 选取正样本, counter 大于90,且过滤掉 VV < 50的
    ...
    #     .save("/home/yujun/Downloads/tag_cluster/numViewsPerVideo", header='true')
    #
    # numViewsPerGaid.repartition(1).write.format('com.databricks.spark.csv')\
    #     .save("/home/yujun/Downloads/tag_cluster/numViewsPerGaid", header='true')
    ...
    res_path = "/home/yujun/Downloads/tag_cluster/action_res_60/"
    ...
    # 近30天的用户行为数据
    # # res_path = "/Users/jun_yu/Downloads/action_log/action_res/"
    # res_path = "/home/yujun/Downloads/tag_cluster/action_res/"
    ...
    # interest_res.select('gaid','tag','ration','total','tag_total')\
    #     .repartition(64)\
    #     .write\
    #     .parquet("/Users/jun_yu/Downloads/action_log/tag_ration_res/")
    #
    # print("+++++++ tag_ration_res insert down ++++++++")
    #
    # # 兴趣向量保存到csv 格式
    # tag_ration_path = "/Users/jun_yu/Downloads/action_log/tag_ration_res/"
    # tag_ration = ss.read.load(tag_ration_path)
    # tag_ration.drop('total','tag_total').show()
    ...
    reshaped1.repartition(1).write\
        ...
        .save("/home/yujun/Downloads/tag_cluster/action_ration_60/", header='true')

    print("++++++++csv file output done++++++++++++")


    # interest_file = "/home/yujun/Downloads/tag_cluster/action_ration/part-00000-be13ea86-fa46-48e3-ae53-9757f223ece1-c000.csv"   # tag>90  
    # interest_file = "/Users/jun_yu/Downloads/action_log/action_ration/part-00000-be13ea86-fa46-48e3-ae53-9757f223ece1-c000.csv"
    # interest_file = "/home/yujun/Downloads/tag_cluster/action_ration_50/part-00000-7ca45fcf-c0ca-4b45-bc7f-1e46a442e32a-c000.csv"
    interest_file = "/home/yujun/Downloads/tag_cluster/action_ration_60/part-00000-9b3dafb2-76ed-4a41-bf30-190b44806c8f-c000.csv"
